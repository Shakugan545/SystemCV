...
class CapacitacionesEditRequest extends FormRequest
{
    /**
    ...
    public function messages()  
    {
        return[
            ...
            'ano_obtenido_capacitacion.digits'      => 'El campo Año no debe exceder los 4 digitos',
            'pais_capacitacion.required'            => 'El campo Pais es obligatorio',
            'pais_capacitacion.regex'               => 'El campo Pais no acepta valores numérico',
            'pais_capacitacion.max'                 => 'El campo Pais no puede exceder los 40 caracteres',
