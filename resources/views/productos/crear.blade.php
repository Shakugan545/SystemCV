...
<br><br>
        ...
        <form method="post" class="formulario-Guardar-productos" action=" {{route('productos.store')}} ">
            {{ @csrf_field() }}
            <div class="col">
        ...
        <div class="form-row">
            <div class="col">
                ...
                @enderror" name="profesores_codigo" id="profesores_codigo" value="{{old('profesores_codigo')}}"
            ...
            <div class="col">
                ...
                @enderror" name="fecha" id="fecha" value="{{old('fecha')}}" placeholder="Fecha">
                @error('fecha')
            ...
            <div class="col">
                <label for="descripcion">Descripción</label>
                    ...
                    <textarea class="form-control text-center @error('descripcion_productos') is-invalid @enderror" 
                     ...
                     >{{old('descripcion_productos')}}</textarea>
...
@section('js')
<script>
    $('.formulario-Guardar-productos').submit(function(e){
        e.preventDefault();
        Swal.fire({
